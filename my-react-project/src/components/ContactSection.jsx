...
import { FaFacebookF, FaTiktok, FaInstagram, FaTwitter, FaLinkedin } from "react-icons/fa";
          ...
          <div>
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-4">
                <a href="https://www.facebook.com/share/1HHXEg1Tsr/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer">
                  <FaFacebookF
                    className="text-3xl hover:text-green-500 cursor-pointer bg-blue-600 p-1 rounded-full"
                    data-aos="fade-up"
                    data-aos-delay="600"
                  />
                </a>
                <a href="https://www.instagram.com/shinypowersolution?igsh=dTBvN3htZGY0bnp3&utm_source=qr" target="_blank" rel="noopener noreferrer">
                  <FaInstagram
                ...
                <FaLinkedin
                  ...
                  data-aos-delay="900"
                />
                <a href="https://www.tiktok.com/@shinypowersolutio?_r=1&_t=ZS-965AEE0qGFE" target="_blank" rel="noopener noreferrer">
                  <FaTiktok
                    className="text-3xl hover:text-green-500 cursor-pointer bg-red-500 p-1 rounded-full"
                    data-aos="fade-up"
                    data-aos-delay="1000"
                  />
                </a>
