...
function HeroSection({title, subtitle, }) {
  return (
    <>
      <section style={{backgroundImage: `url(./solar-panel-image-F.webp)`}}className=" max-h-fit bg-cover bg-center p-8 md:p-16 lg:p-20 space-y-8 flex flex-col justify-center overlay font-Figtree">
