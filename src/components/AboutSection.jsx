...
function AboutSection({ title, description }) {
  return (
    <section className="p-6 md:p-16 lg:p-20 bg-slate-100 font-Figtree">
      <h2 className="text-center text-3xl sm:text-4xl font-semibold mb-8">
        {title}<span className="text-green-500 animate-pulse">Y</span>
      </h2>
      <h3 className="text-green-500 text-center sm:text-xl font-semibold mb-16 sm:w-[60%] mx-auto">
        {description}
      </h3>
      <div className="flex flex-col sm:flex-row items-center gap-6 sm:*:size-2/4 ">
        <figure>
        ...
        <div className="space-y-6">
         <div>
          ...
          <p>With a focus on sustainability, efficiency, and trust, we provide tailored
            ...
            <div className="mt-6 border-2 border-green-500 w-fit mx-auto rounded-full p-2 hover:bg-green-500 hover:text-white transition-all duration-300">
