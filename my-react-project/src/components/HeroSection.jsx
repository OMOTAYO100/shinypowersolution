  ...
  return (
    <>
      <section className="relative h-[90vh] md:h-screen flex flex-col justify-center overflow-hidden font-Figtree">
        ...
        <div className="absolute inset-0 flex justify-center items-start pt-20 md:pt-12 pointer-events-none select-none overflow-hidden -z-5">
        ...
        <div className="mt-26 relative z-10 px-8 md:px-16 lg:px-24 space-y-10 flex flex-col justify-center items-start text-left max-w-7xl w-full">
          <motion.h2 
