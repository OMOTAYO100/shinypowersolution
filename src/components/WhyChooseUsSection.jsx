...
function WhyChooseUsSection({ title }) {
  return (
    <section className="p-6 md:p-16 lg:p-20 space-y-12 bg-slate-100 shadow-lg shadow-gray-600 font-Figtree" data-aos="fade-up" data-aos-delay="200">
      <h2 className="text-2xl sm:text-4xl text-center font-semibold" data-aos="fade-up">
        {title}
      </h2>

      <h4 className="text-center text-gray-400 font-semibold sm:w-[60%] mx-auto" data-aos="fade-up">
